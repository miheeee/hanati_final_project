	  		...
	  		<c:choose>
		 		...
		 		<c:otherwise>
				  	<ul class="list-unstyled check">
			 			...
			 			<c:if test="${gatheringId == loginVO.id }"><button id="terminateCancelBtn" type="button" class="terminateChangeBtn btn btn-primary button  mt-3" style="border-color:#27B2A5;background-color:#27B2A5;">종료 취소</button></c:if>	
		 			</ul>
		 		</c:otherwise>
	  		</c:choose>